 ...
 */
package com.razza.apps.iosched.server.schedule;
...
public interface Config {
  ...
  public static final long[][] CONFERENCE_DAYS =
      new long[][] {
          ...
          { new Date(116, Calendar.JUNE, 02, 14, 0, 0).getTime(),
                  new Date(116, Calendar.JUNE, 03, 5, 0, 0).getTime() },
          // start and end of day 2
          { new Date(116, Calendar.JUNE, 03, 14, 0, 0).getTime(),
                  new Date(116, Calendar.JUNE, 04, 0, 0, 0).getTime() }
      };
...
//  public final String CLOUD_STORAGE_BASE_URL = "https://storage.googleapis.com/"+CLOUD_STORAGE_BUCKET+"/";
  public final String CLOUD_STORAGE_BASE_URL = "http://www.webideas.ph/SAMPLEDB/";
