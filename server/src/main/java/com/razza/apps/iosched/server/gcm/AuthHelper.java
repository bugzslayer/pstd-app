 ...
 */
package com.razza.apps.iosched.server.gcm;
...
public class AuthHelper {
  ...
  private static final String[][] REGISTRATION_KEYS = {
    ...
    {"d51199ef-cb2e-49f2-bf52-f9270eab5a76", "Android app registration key"},
    {"AIzaSyBncAKKXWRFAydpdvDsri7foMwMX3oqbgI", "Android app registration key"}
  };
