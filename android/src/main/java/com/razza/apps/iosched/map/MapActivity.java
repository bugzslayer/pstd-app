...
import com.razza.apps.iosched.session.SessionDetailConstants;
...
/**
 * Activity that displays a {@link com.razza.apps.iosched.map.MapFragment} and a {@link
 * com.razza.apps.iosched.map.MapInfoFragment}.
 ...
 * marker.
 *
 * @see com.razza.apps.iosched.map.MapInfoFragment#newInstace(android.content.Context)
 */
public class MapActivity extends BaseActivity
    ...
    public static final String EXTRA_DETACHED_MODE
            = "com.razza.apps.iosched.EXTRA_DETACHED_MODE";
     ...
     * applied to the map.
     *
     * For {@link com.razza.apps.iosched.map.InlineInfoFragment} (that is only displayed
     * on the left of the screen), the full extend of its container layout (including padding) is
     * passed to the map fragment.
     * For {@link com.razza.apps.iosched.map.SlideableInfoFragment} (that is only
     * displayed
