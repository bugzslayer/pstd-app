...
package com.razza.apps.iosched.provider;

import com.razza.apps.iosched.Config;
import com.razza.apps.iosched.appwidget.ScheduleWidgetProvider;
import com.razza.apps.iosched.provider.ScheduleContract.Announcements;
import com.razza.apps.iosched.provider.ScheduleContract.Blocks;
import com.razza.apps.iosched.provider.ScheduleContract.Feedback;
import com.razza.apps.iosched.provider.ScheduleContract.HashtagColumns;
import com.razza.apps.iosched.provider.ScheduleContract.Hashtags;
import com.razza.apps.iosched.provider.ScheduleContract.MapMarkers;
import com.razza.apps.iosched.provider.ScheduleContract.MapTiles;
import com.razza.apps.iosched.provider.ScheduleContract.MyFeedbackSubmitted;
import com.razza.apps.iosched.provider.ScheduleContract.MySchedule;
import com.razza.apps.iosched.provider.ScheduleContract.MyScheduleColumns;
import com.razza.apps.iosched.provider.ScheduleContract.MyViewedVideos;
import com.razza.apps.iosched.provider.ScheduleContract.Rooms;
import com.razza.apps.iosched.provider.ScheduleContract.SearchSuggest;
import com.razza.apps.iosched.provider.ScheduleContract.SearchTopicsSessions;
import com.razza.apps.iosched.provider.ScheduleContract.Sessions;
import com.razza.apps.iosched.provider.ScheduleContract.Speakers;
import com.razza.apps.iosched.provider.ScheduleContract.Tags;
import com.razza.apps.iosched.provider.ScheduleContract.VideoColumns;
import com.razza.apps.iosched.provider.ScheduleContract.Videos;
import com.razza.apps.iosched.provider.ScheduleDatabase.SessionsSearchColumns;
import com.razza.apps.iosched.provider.ScheduleDatabase.SessionsSpeakers;
import com.razza.apps.iosched.provider.ScheduleDatabase.Tables;
import com.razza.apps.iosched.settings.SettingsUtils;
import com.razza.apps.iosched.util.AccountUtils;
import com.razza.apps.iosched.util.SelectionBuilder;
...
import static com.razza.apps.iosched.util.LogUtils.LOGV;
 ...
 * usually inserted by {@link com.razza.apps.iosched.sync.SyncHelper}, and queried using
...
public class ScheduleProvider extends ContentProvider {
     ...
     * parameter is used by the {@link com.razza.apps.iosched.explore.ExploreSessionsActivity}
     ...
     * {@link com.razza.apps.iosched.sync.ConferenceDataHandler} notifies all top level
     * conference paths once the conference data sync is done, and the
     * {@link com.razza.apps.iosched.sync.userdata.AbstractUserDataSyncHelper} notifies all
