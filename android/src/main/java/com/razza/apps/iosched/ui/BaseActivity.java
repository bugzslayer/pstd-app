...
package com.razza.apps.iosched.ui;
...
import com.razza.apps.iosched.AppApplication;
import com.razza.apps.iosched.BuildConfig;
import com.razza.apps.iosched.R;
import com.razza.apps.iosched.about.AboutActivity;
import com.razza.apps.iosched.debug.DebugActivity;
import com.razza.apps.iosched.explore.ExploreIOActivity;
import com.razza.apps.iosched.framework.Model;
import com.razza.apps.iosched.framework.PresenterFragmentImpl;
...
import com.razza.apps.iosched.gcm.ServerUtilities;
import com.razza.apps.iosched.map.MapActivity;
import com.razza.apps.iosched.myschedule.MyScheduleActivity;
import com.razza.apps.iosched.provider.ScheduleContract;
import com.razza.apps.iosched.service.DataBootstrapService;
import com.razza.apps.iosched.settings.SettingsActivity;
import com.razza.apps.iosched.settings.SettingsUtils;
import com.razza.apps.iosched.social.SocialActivity;
import com.razza.apps.iosched.sync.SyncHelper;
import com.razza.apps.iosched.ui.widget.MultiSwipeRefreshLayout;
import com.razza.apps.iosched.ui.widget.NavDrawerItemView;
import com.razza.apps.iosched.ui.widget.ScrimInsetsScrollView;
import com.razza.apps.iosched.util.AccountUtils;
import com.razza.apps.iosched.util.ImageLoader;
import com.razza.apps.iosched.util.LUtils;
import com.razza.apps.iosched.util.LoginAndAuthHelper;
import com.razza.apps.iosched.util.RecentTasksStyler;
import com.razza.apps.iosched.util.TimeUtils;
import com.razza.apps.iosched.util.UIUtils;
import com.razza.apps.iosched.videolibrary.VideoLibraryActivity;
import com.razza.apps.iosched.welcome.WelcomeActivity;
...
//            mNavDrawerItems.add(NAVDRAWER_ITEM_DEBUG);
    ...
    /**
     * Adds a {@link com.razza.apps.iosched.framework.PresenterFragmentImpl} to the
     * Activity if required, and sets it up with the {@code model}, {@code queries},
     * {@code actions} and the {@link com.razza.apps.iosched.framework.UpdatableView}
     * corresponding to the {@code updatableViewResId}.
     *
     * @return the {@link com.razza.apps.iosched.framework.PresenterFragmentImpl},
     */
     ...
     * {@link com.razza.apps.iosched.util.ThrottledContentObserver} for the given
