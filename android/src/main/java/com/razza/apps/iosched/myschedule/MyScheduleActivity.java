...
package com.razza.apps.iosched.myschedule;

import com.razza.apps.iosched.Config;
import com.razza.apps.iosched.R;
import com.razza.apps.iosched.model.ScheduleHelper;
import com.razza.apps.iosched.model.ScheduleItem;
import com.razza.apps.iosched.provider.ScheduleContract;
import com.razza.apps.iosched.session.SessionDetailActivity;
import com.razza.apps.iosched.settings.SettingsUtils;
import com.razza.apps.iosched.ui.BaseActivity;
import com.razza.apps.iosched.util.AnalyticsHelper;
import com.razza.apps.iosched.util.ThrottledContentObserver;
...
public class MyScheduleActivity extends BaseActivity implements MyScheduleFragment.Listener {
    ...
    private static final String ARG_CONFERENCE_DAY_INDEX
            = "com.razza.apps.iosched.ARG_CONFERENCE_DAY_INDEX";
    ...
    public static final String EXTRA_DIALOG_TITLE
            = "com.razza.apps.iosched.EXTRA_DIALOG_TITLE";
    public static final String EXTRA_DIALOG_MESSAGE
            = "com.razza.apps.iosched.EXTRA_DIALOG_MESSAGE";
    public static final String EXTRA_DIALOG_YES
            = "com.razza.apps.iosched.EXTRA_DIALOG_YES";
    public static final String EXTRA_DIALOG_NO
            = "com.razza.apps.iosched.EXTRA_DIALOG_NO";
    public static final String EXTRA_DIALOG_URL
            = "com.razza.apps.iosched.EXTRA_DIALOG_URL";
    ...
    private void prepareDayZeroAdapter() {
        ...
        item.title = "Room check-in and Registration";
//        item.startTime = 1432742400000l; // 2015/05/27 9:00 AM PST
        item.startTime =   1464789600000l;  // 2016/06/01 2:00 PM PST
//        item.endTime = 1432782000000l; // 2015/05/27 8:00 PM PST
        item.endTime =   1464811200000l; // 2015/06/01 8:00 PM PST
        item.type = ScheduleItem.BREAK;
        item.room = item.subtitle = "Conf. Rm. 1";
        item.sessionType = ScheduleItem.SESSION_TYPE_MISC;
        mDayZeroAdapter.updateItems(Arrays.asList(item));
        item = new ScheduleItem();
        item.title = "Last Day of Learning Programs";
//        item.startTime = 1432742400000l; // 2015/05/27 9:00 AM PST
        item.startTime =   1464768000000l;  // 2016/06/01 8:00 AM PST
//        item.endTime = 1432782000000l; // 2015/05/27 8:00 PM PST
        item.endTime =   1464789600000l; // 2015/06/01 8:00 PM PST
        item.type = ScheduleItem.BREAK;
        item.room = item.subtitle = "Managing the L&D Function\n Facilitating L&D Methodologies";
        item.sessionType = ScheduleItem.SESSION_TYPE_MISC;
        mDayZeroAdapter.updateItems(Arrays.asList(item));
    }
