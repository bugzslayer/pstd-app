...
public class VideoLibraryFilteredActivity extends BaseActivity implements
    ...
    private static final String TAG = LogUtils.makeLogTag(VideoLibraryFilteredActivity.class);

    private static final String SCREEN_LABEL = "Filtered Video Library";

    protected static final String KEY_FILTER_TOPIC =
            "com.razza.apps.iosched.KEY_FILTER_TOPIC";

    protected static final String KEY_FILTER_YEAR =
            "com.razza.apps.iosched.KEY_FILTER_YEAR";
    ...
    public boolean onMenuItemClick(MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            case R.id.menu_filter:
                LogUtils.LOGD(TAG, "Clicking Filter menu button on FilteredVideoLib.");
