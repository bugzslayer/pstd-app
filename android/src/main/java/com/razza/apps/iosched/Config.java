...
package com.razza.apps.iosched;
...
public class Config {
    ...
    public static final String DOGFOOD_BUILD_WARNING_TITLE = "PSTD Unconvention";

    public static final String DOGFOOD_BUILD_WARNING_TEXT = "The purpose of this is to demonstrate"
            + " the capacity of the PSTD Unconvention app. This is exclusively enabled by Razza";
...
//    public static final String IO_EXTENDED_LINK = "http://www.pstduncon2016.com/";
