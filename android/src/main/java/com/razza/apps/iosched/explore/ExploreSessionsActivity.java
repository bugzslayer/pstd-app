...
import com.razza.apps.iosched.model.TagMetadata;
...
import com.razza.apps.iosched.ui.SearchActivity;
...
public class ExploreSessionsActivity extends BaseActivity
    ...
    public static final String EXTRA_FILTER_TAG =
            "com.razza.apps.iosched.explore.EXTRA_FILTER_TAG";
    public static final String EXTRA_SHOW_LIVE_STREAM_SESSIONS =
            "com.razza.apps.iosched.explore.EXTRA_SHOW_LIVE_STREAM_SESSIONS";

    // The saved instance state filters
    private static final String STATE_FILTER_TAGS =
            "com.razza.apps.iosched.explore.STATE_FILTER_TAGS";
    private static final String STATE_CURRENT_URI =
            "com.razza.apps.iosched.explore.STATE_CURRENT_URI";
     ...
     * {@link com.razza.apps.iosched.model.TagMetadata}
     */
    private class TagAdapter implements CollectionViewCallbacks {

        /**
         * Returns a new instance of {@link CollectionView.Inventory}. It always contains three
         * {@link CollectionView.InventoryGroup} groups.
         * <ul>
        ...
        public CollectionView.Inventory getInventory() {
            ...
            CollectionView.InventoryGroup typesGroup = new CollectionView.InventoryGroup(GROUP_TOPIC_TYPE_OR_THEME)
                    .setDataIndexStart(0)
                    .setShowHeader(true);
            ...
            CollectionView.InventoryGroup topicsGroup = new CollectionView.InventoryGroup(GROUP_TOPIC_TYPE_OR_THEME)
                    .setDataIndexStart(0)
                    .setShowHeader(true);
